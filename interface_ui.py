...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("QMainWindow { background-color: #2b2b2b; }")
        ...
        sizePolicy.setHeightForWidth(self.pushButton_Plas.sizePolicy().hasHeightForWidth())
        self.pushButton_Plas.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Ларионов Н.Ю. 510з Калькулятор"))
